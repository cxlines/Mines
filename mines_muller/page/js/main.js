...
function gameOver(isWin) {
  let message = null;
  if (isWin) {
    message = 'Szep volt! Meg is van a nyertes :)';
    $('#board').find('.col.mine').addClass('winnr mine');

  } else {
    message = 'Megy ez jobban is! Probaljuk ujra?';
    $('#board').find('.col.mine').addClass('losr mine');
  }
